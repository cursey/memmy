...
Test(Test_MemmyCliHelpAndVersion)
{
    ...
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(help_argv), help_argv, &out, &error), Memmy_Status_Ok);
    ...
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(version_argv), version_argv, &out, &error),
             Memmy_Status_Ok);
    AssertStrEq(out, String8_Lit("memmy 0.0.0\n"));

    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(jsonl_help_argv), jsonl_help_argv, &out, &error),
             Memmy_Status_Ok);
    AssertTrue(String8_Find(out, String8_Lit("Global options:"), 0) != STRING8_NPOS);

    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(jsonl_version_argv), jsonl_version_argv, &out, &error),
             Memmy_Status_Ok);
    AssertStrEq(out, String8_Lit("memmy 0.0.0\n"));
...
Test(Test_MemmyCliRejectsAmbiguousInputSources)
{
    ...
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(expr_file), expr_file, &out, &error),
             Memmy_Status_InvalidArgument);
    AssertStrEq(error.context, String8_Lit("cli"));
    AssertStrEq(error.input, String8_Lit("--expr"));

    error = (Memmy_Error){0};
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(two_files), two_files, &out, &error),
    ...
    error = (Memmy_Error){0};
    AssertEq(
        MemmyCli_Input_RunString(arena, (I32)ArrayCount(stdin_expr), stdin_expr, String8_Lit("0x1000\n"), &out, &error),
        Memmy_Status_InvalidArgument);
    AssertStrEq(error.context, String8_Lit("cli"));
    AssertStrEq(error.input, String8_Lit("--expr"));
    ...
    error = (Memmy_Error){0};
    AssertEq(
        MemmyCli_Input_RunString(arena, (I32)ArrayCount(stdin_file), stdin_file, String8_Lit("0x1000\n"), &out, &error),
        Memmy_Status_InvalidArgument);
    AssertStrEq(error.context, String8_Lit("cli"));
...
Test(Test_MemmyCliFormerSubcommandNamesAreFilePaths)
{
    ...
    error = (Memmy_Error){0};
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(procs_argv), procs_argv, &out, &error),
...
Test(Test_MemmyCliJsonlHelpers)
{
    ...
    AssertEq(MemmyCli_Argv_HasHelp((I32)ArrayCount(help_flag), help_flag), 1);
    AssertEq(MemmyCli_Argv_HasVersion((I32)ArrayCount(version_flag), version_flag), 1);
    AssertEq(MemmyCli_Argv_HasHelp((I32)ArrayCount(help_value), help_value), 0);
    AssertEq(MemmyCli_Argv_HasVersion((I32)ArrayCount(version_value), version_value), 0);
...
Test(Test_MemmyCliInvalidOptions)
{
    ...
    AssertEq(MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(json_option), json_option, &out, &error),
             Memmy_Status_InvalidArgument);
    AssertStrEq(error.context, String8_Lit("cli"));
    ...
    error = (Memmy_Error){0};
    AssertEq(
        MemmyCli_Argv_RunToString(arena, (I32)ArrayCount(invalid_script_option), invalid_script_option, &out, &error),
        Memmy_Status_InvalidArgument);
    AssertStrEq(error.context, String8_Lit("cli"));
...
Test(Test_MemmyCliExitCodeMapping)
{
    ...
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_ParseError), 2);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_InvalidArgument), 2);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_Overflow), 2);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_InvalidEncoding), 2);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_NotFound), 3);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_Ambiguous), 3);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_AccessDenied), 4);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_PartialRead), 5);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_PartialWrite), 5);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_Unsupported), 6);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_PlatformError), 7);
    AssertEq(MemmyCli_ExitCode_FromStatus(Memmy_Status_Unreadable), 1);
}
